...
def resnet_18(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet_18", BasicBlock, [2, 2, 2, 2], pretrained, progress, **kwargs
    )
...
def resnet_34(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet_34", BasicBlock, [3, 4, 6, 3], pretrained, progress, **kwargs
    )
...
def resnet_50(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet_50", Bottleneck, [3, 4, 6, 3], pretrained, progress, **kwargs
    )
...
def resnet_101(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet_101", Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs
    )
...
def resnet_152(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet(
        "resnet_152", Bottleneck, [3, 8, 36, 3], pretrained, progress, **kwargs
    )
...
def resnext_101_32x8d(pretrained=False, progress=True, **kwargs):
    ...
    return _resnet(
        "resnext_101_32x8d", Bottleneck, [3, 4, 23, 3], pretrained, progress, **kwargs
    )
